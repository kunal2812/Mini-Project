...
inception_model = tf.keras.models.load_model(filepath=Path('./SavedModels/inception_v3.h5'))
resnet_model = tf.keras.models.load_model(filepath=Path('./SavedModels/resnet50_v2.h5'))
densenet_model = tf.keras.models.load_model(filepath=Path('./SavedModels/densenet201.h5'))
